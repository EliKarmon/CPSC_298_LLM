    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600">Current Time: {new Date().toLocaleTimeString()}</p>
        </div>
      </header>
      <main>
                ...
                <Card key={ride.id}>
                  ...
                  <CardContent>
                    ...
                    <div className="flex items-center mb-2">
                      ...
                      <span>Leaves in {Math.max(0, Math.floor((new Date(ride.departure).getTime() - new Date().getTime()) / 60000))} minutes</span>
                    </div>
                    <div className="flex items-center mb-2">
                      <Clock className="mr-2 h-4 w-4" />
